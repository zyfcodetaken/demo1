...
<body>
    <div class="head">
            ...
            <h3 class="head_text fr">奥莱弗电子商务后台管理系统</h3>
    </div>
    <div class="operation_user clearfix">
       <!--   <div class="link fl"><a href="#">慕课</a><span>&gt;&gt;</span><a href="#">商品管理</a><span>&gt;&gt;</span>商品修改</div>-->
        <div class="link fr">
            ...
            </b>&nbsp;&nbsp;&nbsp;&nbsp;<a href="../index.php" class="icon icon_i">首页</a><span></span><input type=button value=前进 onclick="window.history.go(1)">  <span></span><input type=button value=后退 onclick="window.history.go(-1)"><span></span><input type=button value=刷新 onclick="window.location.reload()"> <span></span><a href="doAdminAction.php?act=logout" class="icon icon_e">退出</a>
        </div>
    </div>
                ...
                <ul class="mList">
                    ...
                    <li>
                        ...
                        <dl id="menu3" style="display:none;">
                            <dd><a href="listorder.php" target="mainFrame">订单浏览</a></dd>
                        </dl>
                    </li>
                    <li>
                    ...
                    <li>
                        <h3><span onclick="show('menu7','change7')" id="change7">+</span>美食管理</h3>
                        <dl id="menu7" style="display:none;">
                            <dd><a href="addFood.php" target="mainFrame">添加美食</a></dd>
                            <dd><a href="listFood.php" target="mainFrame">美食列表</a></dd>
                        </dl>
                    </li>
